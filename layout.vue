	...
	<div class=buma>
		<div class="nav navbar" role="navigation" aria-label="main navigation">
			...
			<div class="navbar-menu" id="mainNavbar">
				<div class="navbar-start">
					<nuxt-link href="/RecentChanges" class="navbar-item">
						<span class="icon">
							<i class="fas fa-binoculars"></i>
						</span> 최근 변경</nuxt-link>
					<nuxt-link href="/RecentDiscuss" class="navbar-item">
						<span class="icon">
							<i class="far fa-comments"></i>
						</span> 최근 토론</nuxt-link>
					<div class="navbar-item has-dropdown is-hoverable">
						...
						<div class="navbar-dropdown">
							<nuxt-link class="navbar-item" href="/NeededPages">
								<span class="icon">
									<i class="fas fa-beer"></i>
								</span>
								작성이 필요한 문서
							</nuxt-linknuxt-link>
							<nuxt-link class="navbar-item" href="/OrphanedPages">
								<span class="icon">
									<i class="far fa-frown"></i>
								</span>
								고립된 문서
							</nuxt-link>
							<nuxt-link class="navbar-item" href="/UncategorizedPages">
								<span class="icon">
									<i class="far fa-question-circle"></i>
								</span>
								분류가 되지 않은 문서
							</nuxt-link>
							<nuxt-link class="navbar-item" href="/OldPages">
								<span class="icon">
									<i class="fas fa-pause"></i>
								</span>
								편집된 지 오래된 문서
							</nuxt-link>
							<nuxt-link class="navbar-item" href="/ShortestPages">
								<span class="icon">
									<i class="far fa-thumbs-down"></i>
								</span>
								내용이 짧은 문서
							</nuxt-link>
							<nuxt-link class="navbar-item" href="/LongestPages">
								<span class="icon">
									<i class="far fa-thumbs-up"></i>
								</span>
								내용이 긴 문서
							</nuxt-link>
							<nuxt-link class="navbar-item" href="/BlockHistory">
								<span class="icon">
									<i class="fas fa-ban"></i>
								</span>
								차단 내역
							</nuxt-link>
							<nuxt-link class="navbar-item" href="/RandomPage">
								<span class="icon">
									<i class="fas fa-random"></i>
								</span>
								RandomPage
							</nuxt-link>
							<nuxt-link class="navbar-item" href="/Upload">
								<span class="icon">
									<i class="fas fa-cloud-upload-alt"></i>
								</span>
								파일 올리기
							</nuxt-link>
							<nuxt-link class="navbar-item" href="/License">
								<span class="icon">
			...
			<div class="navbar-end">
				...
				<div class="navbar-item has-dropdown is-hoverable">
					...
					<div class="navbar-dropdown is-right">
						...
						{% if member %}
						<a href="/member/mypage" class="navbar-item">
							<span class="icon">
								<i class="far fa-user-circle"></i>
							</span> 내정보</a>
						<a href="/w/{{ member.username | encode_userdoc }}" class="navbar-item">
							<span class="icon">
								<i class="far fa-sticky-note"></i>
							</span> 내 사용자 문서</a>
						<div class="navbar-divider"></div>
						<a href="/contribution/author/{{ member.username }}/document" class="navbar-item">
							<span class="icon">
								<i class="fas fa-chart-line"></i>
							</span> 내 문서 기여 목록</a>
						<a href="/contribution/author/{{ member.username }}/discuss" class="navbar-item">
							<span class="icon">
								<i class="fas fa-chart-bar"></i>
							</span> 내 토론 기여 목록</a>
						<a href="/member/starred_documents" class="navbar-item">
							<span class="icon">
								<i class="fas fa-bookmark"></i>
							</span> 별찜한 문서들
						</a>
						<div class="navbar-divider"></div>
						<a href="/member/logout?redirect={{ url | url_encode }}" class="navbar-item">
							<span class="icon">
								<i class="fas fa-sign-out-alt"></i>
							</span> 로그아웃</a>
						{% else %}
						<a href="/contribution/author/{{ req_ip }}/document" class="navbar-item">
							<span class="icon">
								<i class="fas fa-chart-line"></i>
							</span> 내 문서 기여 목록</a>
						<a href="/contribution/author/{{ req_ip }}/discuss" class="navbar-item">
							<span class="icon">
								<i class="fas fa-chart-bar"></i>
							</span> 내 토론 기여 목록</a>
						<div class="navbar-divider"></div>
						<a href="/member/login?redirect={{ url | url_encode }}" class="navbar-item">
							<span class="icon">
		...
		<section class="hero {% if error || skinInfo.viewName === 'notfound' %}is-danger{% else %}is-primary{% endif %}" id="wiki-main-title">
			<div class="hero-body">
				<div class="container">
					<h1 class="title">
						{{ skinInfo.title }}{% if rev %} (r{{ rev }} 판){% endif %}
					</h1>
					<h2 class="subtitle">
						{% if skinInfo.viewName == 'wiki' and date %}
						{{ date | to_date | localdate('Y-m-d H:i:sO') }}에 마지막으로 수정됐습니다.
						{% elseif skinInfo.viewName == 'notfound' %}
